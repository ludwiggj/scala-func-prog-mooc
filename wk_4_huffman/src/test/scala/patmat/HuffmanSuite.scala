...
class HuffmanSuite extends FunSuite {
  ...
  test("times using 'this is an example of a huffman tree'") {
    assert(times(string2Chars("this is an example of a huffman tree")).sorted ===
      List(('e', 4), ('a', 4), (' ', 7), ('n', 2), ('t', 2), ('m', 2), ('i', 2), ('h', 2), ('s', 2),
           ('f', 3), ('o', 1), ('u', 1), ('x', 1), ('p', 1), ('r', 1), ('l', 1)).sorted)
  }
  ...
  test("encodedSecret") {
    assert(encode(frenchCode)(List('h', 'u', 'f', 'f', 'm', 'a', 'n', 'e', 's', 't', 'c', 'o', 'o', 'l'))
